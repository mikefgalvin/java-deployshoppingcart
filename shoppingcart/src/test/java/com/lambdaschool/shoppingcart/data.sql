...
INSERT INTO USERS(USERID, USERNAME, PRIMARYEMAIL, PASSWORD, COMMENTS, CREATEDBY, CREATEDDATE, LASTMODIFIEDBY, LASTMODIFIEDDATE)
     VALUES (1, 'barnbarn', 'barnbarn@host.local', '$2y$12$w5Y2sBkeQcZQzFOQXntyTufpqEk8szw3fs1gJO1ef9mPk3GD4eOAu', '', 'SYSTEM', CURRENT_TIMESTAMP, 'SYSTEM', CURRENT_TIMESTAMP),
            (2, 'cinnamon', 'cinnamon@host.local', '$2y$12$w5Y2sBkeQcZQzFOQXntyTufpqEk8szw3fs1gJO1ef9mPk3GD4eOAu', '', 'SYSTEM', CURRENT_TIMESTAMP, 'SYSTEM', CURRENT_TIMESTAMP),
            (3, 'stumps', 'stumps@host.local', '$2y$12$w5Y2sBkeQcZQzFOQXntyTufpqEk8szw3fs1gJO1ef9mPk3GD4eOAu', '', 'SYSTEM', CURRENT_TIMESTAMP, 'SYSTEM', CURRENT_TIMESTAMP);
